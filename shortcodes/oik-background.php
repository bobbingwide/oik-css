 ...
 * Note: Some themes display the featured image prominently. 
 * 
 * 
...
function bw_default_selector_for_theme() {
  ...
  $selector = apply_filters( "bw_default_selector_for_theme", "body.custom-background" );
  return( $selector );
} 
...
function bw_background( $atts=null, $content=null, $tag=null ) {
  ...
  $atts['id'] = bw_array_get_from( $atts, "id,0", bw_current_post_id() );
